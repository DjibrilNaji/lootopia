  ...
  reasons = [
    {
      ...
      description:
        "Expériences immersives avec  des éléments virtuels dans le monde réel.",
      icon: <GitPullRequest className="size-6" />,
    },
    {
      title: "Géolocalisation en Temps Réel",
      description:
        "Découvrez des caches cachées grâce à une géolocalisation précise.",
      icon: <SquareKanban className="size-6" />,
    },
    {
      title: "Création de Contenu",
      description:
        "Créez des parcours sur mesure adaptés à vos besoins.",
      icon: <RadioTower className="size-6" />,
    },
    {
      title: "Notifications Instantanées",
      description:
        "Recevez des alertes et des indices en temps réel.",
      icon: <WandSparkles className="size-6" />,
    },
    {
      title: "Classement et Récompenses",
      description:
        "Compétitionnez avec d'autres participants et gagnez des récompenses.",
      icon: <Layers className="size-6" />,
    },
    {
      title: "Communauté et Partage",
      description:
        "Interagissez avec d'autres chasseurs de trésors et partagez vos expériences.",

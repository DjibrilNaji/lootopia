...
const Gallery = ({ items = data }: GalleryProps) => {
  ...
  return (
    <section className="w-screen bg-purple-500 py-10 ">
      <div className="container  flex justify-center items-center  ">
        <div className="mb-8 flex items-end justify-between md:mb-14 lg:mb-16">
          <div className="flex flex-col gap-4">
            <h2 className="text-3xl font-medium md:text-4xl lg:text-5xl">
              Rencontrez les visionnaires derrière notre succès :
              <span className="italic text-yellow-400"> les esprits innovants </span>
              qui façonnent l’avenir de notre entreprise
            </h2>
          </div>
